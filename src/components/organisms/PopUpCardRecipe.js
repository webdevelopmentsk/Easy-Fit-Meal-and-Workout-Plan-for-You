            ...
            <div className ="popup">
                <div className ="popup_inner popUpCardRecipe__container">
                    ...
                    <div className ="popUpCardRecipe__content">
                            ...
                            <div className="popUpCardRecipe__content__main">
                                <div className="popUpCardRecipe__content__main__heading heading heading__m">{props.item.label}</div>
                                <div className="popUpCardRecipe__content__main__preparation">
                                    <a className="popUpCardRecipe__content__main__preparation--link" href= {props.item.url} target="_blank" rel="noopener noreferrer">{props.content.popup.preparation}</a>
                                </div>
                            </div>
                            <div className ="popUpCardRecipe__main__content__addToMeal">
                            ...
                            <div className ="popUpCardRecipe__content__ingred">
                                ...
                                {props.content.popup.ingredients}
                                </div>
